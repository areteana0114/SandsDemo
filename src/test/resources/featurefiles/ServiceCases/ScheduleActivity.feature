...
Feature: Validate the Schedule Activity feature.
  ...
  Scenario: Launch the interaction with Sarah Connor for Schedule Activity Service Case and create task.
    ...
    And Open the required Case Id by clicking on "S-176" link
  ...
  #   And Enter "comments" in note field
   ...
   #   And Enter "comments" in note field
    ...
    Examples: 
      ...
      | Incorrect Billing      | Personal Checking : 12345678             | S-177  |
      | Research Credit Issues | Platinum Rewards Card : 7895543245678901 | S-178  |
