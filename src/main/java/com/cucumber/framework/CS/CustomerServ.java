...
public class CustomerServ extends SeleniumFunc implements CustomerServLoc {
	...
	//code to select Add Task button
		...
		public void clickSubmit() {
			...
			public void selectWB(String value) {
				WebElement workBasketLink=driver.findElement(By.xpath(workbasketlink_xpath));
				goToFrame(workBasketLink);
			    waitForElement(workBasketLink,2);
				workBasketLink.click();
				WebElement viewQueueForDropdown=driver.findElement(By.xpath(viewqueuefordropdown_xpath));
				goToFrame(viewQueueForDropdown);
				waitForElement(viewQueueForDropdown,2);
